...
def create_dra_axis_minimal_device(sensor, cmap="coolwarm", centre=None, scale=2.5, draw_axis=True, subplot=111, ax=None, flip=False):
    """
    Draws the DRA and the responses of its ommatidia.
    ...
    size = 20. * scale
    ax.text(centre[0] - .3, centre[1] + .5, "POL neuron locations", fontsize=15)
    n_neurons = len(omm_y)
